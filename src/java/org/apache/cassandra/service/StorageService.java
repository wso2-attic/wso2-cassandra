...
public class StorageService extends NotificationBroadcasterSupport implements IEndpointStateChangeSubscriber, StorageServiceMBean
{
    ...
    public synchronized void initServer(int delay) throws ConfigurationException
    {
        ...
        /* The functionality implemented within the shutdown hook below has been moved to the
        deactivate method Carbon Cassandra component ServiceComponent in order to provide proper
        control over Cassandra Shutdown process to the Carbon component */
